...
from data_visualization import dtu_grey, dtu_reds_cmap
from algorhitms import bristol_CIMR


# Load SMRT CSVs
path_187V = r"C:\Users\user\OneDrive\Desktop\Bachelor\SMRT\CIMR\CIMR_18.7GHz_V_merged.csv"
path_314H = r"C:\Users\user\OneDrive\Desktop\Bachelor\SMRT\CIMR\CIMR_36.5GHz_H_merged.csv"
path_314V = r"C:\Users\user\OneDrive\Desktop\Bachelor\SMRT\CIMR\CIMR_36.5GHz_V_merged.csv"
...
print(f"Correlation between SMRT Bristol SIC and CICE aice: {correlation_sorted:.3f}")
...
def plot_diff(lat, lon, cvalue, colorbar_min, colorbar_max, filename):
    ...
    sc = ax.scatter(lon, lat, c=cvalue, cmap=dtu_reds_cmap, norm=norm, s=0.1, transform=ccrs.PlateCarree())
...
plot_diff(df_grid_sorted['lat'], df_grid_sorted['lon'], diff,
          colorbar_min=0, colorbar_max=0.2, filename='smrt_vs_cice_diff.png')
