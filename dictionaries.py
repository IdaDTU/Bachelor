...
# Define dictionary for CIMR IFOV (in km)
CIMR_tracks = {6.9:  {"IFOV": {"along_track": 11, "cross_track": 19}},
               10.7: {"IFOV": {"along_track": 7,  "cross_track": 13}},
               18.7: {"IFOV": {"along_track": 4,  "cross_track": 6}},
               36.5: {"IFOV": {"along_track": 3,  "cross_track": 5}}}

# Define dictionary for MWI IFOV (in km)
MWI_tracks = {18.7: {"IFOV": {"along_track": 35, "cross_track": 65}},
              23.8: {"IFOV": {"along_track": 35, "cross_track": 65}},
              31.4: {"IFOV": {"along_track": 23, "cross_track": 37}},
              89:   {"IFOV": {"along_track": 8, "cross_track":12}}}
